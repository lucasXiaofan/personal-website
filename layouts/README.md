...
- 2026-09-14 — All Reusable detail pages now use the shared comments partial; Decision Log keeps its existing threads.
- 2026-09-14 — `single.html` renders Decision Log English/中文 sections separately, exposes a remembered language switch, and embeds existing discussions by number via giscus. Reusable language blocks use the same switch; bilingual pages omit the mixed-language table of contents.
