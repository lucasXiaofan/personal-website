...
if(index.some(e=>!['reusable','journal'].includes(e.section))) throw new Error('Unexpected search section');
for(const url of ['index.html','reusable/index.html','journal/index.html','faq/index.html','post/typical-sampling/index.html']) {
